...
INPUT_FILE = ROOT / "data" / "processed" / "nhanes_2003_2006_real_cohort.csv"
OUTPUT_FILE = ROOT / "data" / "processed" / "normalized" / "nhanes_2003_2006_real_cohort_normalized.csv"
ACTIONS_FILE = ROOT / "data" / "processed" / "normalized" / "nhanes_2003_2006_real_cohort_normalization_actions.csv"
REFERENCES_FILE = ROOT / "data" / "processed" / "normalized" / "nhanes_2003_2006_reference_ranges_used.csv"
METADATA_FILE = ROOT / "data" / "processed" / "normalized" / "nhanes_2003_2006_hybrid_normalizer_metadata.json"
NORMALIZER_FILE = ROOT / "models" / "nhanes_2003_2006_hybrid_normalizer.joblib"
...
def main() -> None:
    ...
    metadata = {
        ...
        "notes": "Same hybrid normalization logic as scripts/normalize_final_dataset.py, fit on the NHANES 2003-2006 real cohort.",
    }
    ...
    print(f"Saved normalization actions to {ACTIONS_FILE}")
