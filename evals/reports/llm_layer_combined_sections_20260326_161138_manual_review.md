# Manual Review Pack — llm_layer_combined_sections_20260326_161138
...
- `symptom_summary_quality`: weak | adequate | strong
- `doctor_recommendation_quality`: weak | adequate | strong
- `doctor_kit_quality`: weak | adequate | strong
- `lab_recommendation_quality`: weak | adequate | strong
- `recovery_outlook_quality`: missing | weak | adequate | strong
...
- Hallucinated IDs: `[]`
- Section checks: `{'symptom_summary_present': True, 'symptom_summary_structured': False, 'doctor_recommendation_present': True, 'doctor_recommendation_populated': True, 'doctor_kit_aligned': True, 'doctor_kit_populated': True, 'lab_recommendation_present': True, 'recovery_outlook_present': False, 'supported_condition_count': 3, 'recommended_doctor_count': 2, 'doctor_kit_count': 2, 'insight_count': 3, 'summary_point_count': 0, 'recovery_outlook_expected': False}`
...
- Recommended doctors: `['GP', 'Sleep specialist', 'Nephrologist']`
- Review decision:
  symptom_summary_quality: 
  doctor_recommendation_quality: 
  doctor_kit_quality: 
...
- Hallucinated IDs: `[]`
- Section checks: `{'symptom_summary_present': True, 'symptom_summary_structured': False, 'doctor_recommendation_present': True, 'doctor_recommendation_populated': True, 'doctor_kit_aligned': True, 'doctor_kit_populated': True, 'lab_recommendation_present': True, 'recovery_outlook_present': False, 'supported_condition_count': 3, 'recommended_doctor_count': 1, 'doctor_kit_count': 1, 'insight_count': 3, 'summary_point_count': 0, 'recovery_outlook_expected': False}`
...
- Recommended doctors: `['Endocrinologist']`
- Review decision:
  symptom_summary_quality: 
  doctor_recommendation_quality: 
  doctor_kit_quality: 
